...
Text:="|<>*106$62.zzzzzzzzzzkTzvxzzzzzxnzzrzzzzyRQlkcL71zzqrPdvRinTzyA6tCrPZrzzbTiQhqtRzztrvjfRirTzwhz66lQRrzzPzzzzzzzzzbTzzzzzzzzzy"

if (ok:=FindText(X, Y, 3141-150000, -1231-150000, 3141+150000, -1231+150000, 0, 0, Text))
{
  ...
  ; ; {
    ...
    ; ; {
      ...
      ; ; Loop, % n
        ...
        ; ; , (y<y1 && y1:=y), (y>y2 && y2:=y)
      ; ; Loop, % n
        ; ; arr[A_Index]:=[(r[j+=3]-x1)|(r[j+1]-y1)<<16
        ; ; , Floor("0x" StrReplace(r[j+2],"0x"))&0xFFFFFF]
      ; ; w:=x2-x1+1, h:=y2-y1+1
    ; ; }
    ; ; VarSetCapacity(v, n*18*(1+!!A_IsUnicode))
    ; ; , len1:=n, len0:=0
